            ...
            <table class="w-full min-w-[1080px] text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    >
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <div>
                                    <p class="font-semibold">
                                        {{ beneficiaire.client_nom }}
                                    </p>
                                    <p
                                        v-if="beneficiaire.telephone"
                        ...
                        <td
                            class="px-4 py-3 text-right text-red-600 tabular-nums dark:text-red-400"
                        >
                            {{
                                beneficiaire.total_frais > 0
                                    ? `-${formatGNF(beneficiaire.total_frais)}`
                                    : formatGNF(0)
                            }}
                        </td>
                        <td
                        ...
                        <td class="px-4 py-3">
                            <StatusDot
                                ...
                                :label="beneficiaire.statut_label"
                            />
                        </td>
                    </ClickableTableRow>
                </tbody>

        ...
        <div class="mx-auto flex w-full max-w-5xl flex-col gap-6 p-4 sm:p-6">
            ...
            <div class="hidden items-start justify-between gap-4 sm:flex">
                <div class="flex items-center gap-4">
                    <div
                        class="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl border bg-muted/40"
                    >
                    ...
                    <div>
                        ...
                        <div
                            class="mt-1 flex flex-wrap items-center gap-x-5 gap-y-1 text-sm text-muted-foreground"
                        >
                            <span>
                                Code :
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
                    ...
                    <dl class="space-y-3 text-sm">
                        ...
                        >
                            ...
                            <dd>
                                <a
                                    :href="
                                        mapsUrl(site.latitude, site.longitude)
                                    "
                                    target="_blank"
                                    rel="noopener"
                ...
                <div class="rounded-xl border bg-card p-5">
                    ...
                    <dl class="space-y-3 text-sm">
                        ...
                        <p
                            v-if="!site.telephone && !site.email"
                            class="text-muted-foreground italic"
                        >
                ...
                <div
                    ...
                    :class="{ 'md:col-span-2': !site.description }"
                >
                    <h2
                        class="mb-4 flex items-center gap-2 text-sm font-semibold tracking-wider text-muted-foreground uppercase"
                    >
                    ...
                    <div v-if="site.parent_nom" class="mb-3 text-sm">
                        ...
                        <Link
                            ...
                            class="flex items-center gap-2 rounded-lg border bg-muted/30 px-3 py-2 transition-colors hover:bg-muted/60"
                        >
                    ...
                    <p
                        v-if="!site.parent_nom && site.enfants.length === 0"
            ...
            >
                ...
                <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        <div
                            class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-semibold uppercase"
                        >
                            {{ u.name.charAt(0) }}
                        </div>
                        <div class="min-w-0">

    ...
    <AppLayout :breadcrumbs="breadcrumbs" :hide-mobile-header="true">
        ...
        <div class="flex flex-col sm:hidden">
            ...
            <div class="sticky top-0 z-10 flex items-center gap-2 border-b bg-background px-3 py-2">
                ...
                <span class="flex-1 text-center text-sm font-semibold">Sites</span>
            ...
            <div class="divide-y">
                ...
                >
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="truncate font-medium text-sm">{{ s.nom }}</div>
                        <div class="flex items-center gap-1.5 mt-0.5 flex-wrap">
                            <span class="inline-block rounded bg-muted px-1.5 py-0.5 font-mono text-[11px] text-muted-foreground">
                                {{ s.code }}
                            </span>
                            <span class="inline-flex items-center rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium">
                                {{ s.type_label }}
                            </span>
                        </div>
                    ...
                    <StatusDot
                        ...
                        :dot-class="s.statut === 'active' ? 'bg-emerald-500' : 'bg-zinc-400 dark:bg-zinc-500'"
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" class="w-44">
                            <DropdownMenuItem as-child>
                                <Link :href="`/sites/${s.id}`" class="flex items-center gap-2 w-full">
                                    <Eye class="h-4 w-4" />
                                    Voir
                                </Link>
                            </DropdownMenuItem>
                            <DropdownMenuItem v-if="can('sites.update')" as-child>
                                <Link :href="`/sites/${s.id}/edit`" class="flex items-center gap-2 w-full">

...
import { ArrowLeft, Car, Pencil, Plus, UserRound } from 'lucide-vue-next';
            ...
            <div v-else class="rounded-xl border bg-card p-5 sm:p-6">
                ...
                <div v-else class="overflow-x-auto rounded-lg border">
                    <table class="w-full text-sm">
                        ...
                        >
                            <tr>
                                <th class="px-4 py-3 font-medium">Vehicule</th>
                                <th class="px-4 py-3 font-medium">
                                    Immatriculation
                                </th>
                                <th class="px-4 py-3 font-medium">Type</th>
                                <th class="px-4 py-3 font-medium">Capacite</th>
                                <th class="px-4 py-3 font-medium">Equipe</th>

...
const UPLOAD_TOAST_GROUP = 'import-vehicules-maj-upload';
...
function submit() {
    ...
    form.post('/backoffice/vehicules/imports-maj', {
        forceFormData: true,
        onFinish: () => {
...
<template>
    <Head title="Véhicules - Mise à jour en masse" />
        ...
        <div class="mx-auto w-full max-w-2xl space-y-6 p-4 sm:p-6">
            <div class="flex items-center justify-between gap-2">
                <div>
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Site, capacités et usages (vente/logistique) de
                        véhicules déjà existants — jamais de création.
                    </p>
                </div>
            ...
            <div class="rounded-xl border bg-card p-5 sm:p-6">
                ...
                <p class="mt-2 text-sm text-muted-foreground">
                    Le fichier contient une ligne par véhicule déjà existant :
                    immatriculation (clé, non modifiable), site, capacités par
                    catégorie et usages vente/logistique.
                </p>
                <p class="mt-2 text-sm text-muted-foreground">
                    Modifiez uniquement les valeurs à changer et laissez les
                    autres cellules telles quelles — une cellule vide signifie «
                    ne pas modifier ».
                </p>
                <a

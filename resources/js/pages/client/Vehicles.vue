                    ...
                    <form class="space-y-4" @submit.prevent="submitProposal">
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label
                                    class="text-sm font-medium text-foreground"
                                    >Immatriculation <span class="text-red-500">*</span></label
                                >
                                <input
                            ...
                            <div>
                                <label
                                    class="text-sm font-medium text-foreground"
                                    >Type de vehicule <span class="text-red-500">*</span></label
                                >
                                <select
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    />
                                    <Lock class="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground/60" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="text-sm font-medium text-foreground"
                                >Photo du vehicule <span class="text-red-500">*</span></label
                            >
                            <div

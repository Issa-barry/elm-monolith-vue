...
import { ArrowLeft, MoreVertical, Pencil, Plus, Search, Trash2, Users } from 'lucide-vue-next';
...
const typeColor: Record<string, string> = {
    ...
    mecanicien: 'bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-300',
    consultant:  'bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-300',
    fournisseur: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300',
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs" :hide-mobile-header="true">
        ...
        <div class="flex flex-col sm:hidden">
            ...
            <div class="sticky top-0 z-10 flex items-center gap-2 border-b bg-background px-3 py-2">
                ...
                <span class="flex-1 text-center text-sm font-semibold">Prestataires</span>
                <Link v-if="can('prestataires.create')" href="/prestataires/create">
                ...
                >
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <span
                            ...
                            :class="typeColor[p.type] ?? 'bg-muted text-muted-foreground'"
                        >
                            {{ p.type_label }}
                        </span>
                    </div>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" class="w-44">
                            <DropdownMenuItem v-if="can('prestataires.update')" as-child>
                                <Link :href="`/prestataires/${p.id}/edit`" class="flex items-center gap-2 w-full">
                                    <Pencil class="h-4 w-4" />
                                    Modifier
                                </Link>
                            </DropdownMenuItem>
                            <DropdownMenuSeparator v-if="can('prestataires.update') && can('prestataires.delete')" />
                            <DropdownMenuItem
        ...
        <div class="hidden sm:flex flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight">Prestataires</h1>
            ...
            <div class="overflow-hidden rounded-xl border bg-card">
                <DataTable
                    ...
                    :rows="20"
                    :global-filter-fields="['nom_complet', 'reference', 'email', 'phone', 'type_label', 'ville']"
                        ...
                        <template #body="{ data }">
                            <div class="flex justify-end">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" class="w-44">
                                        <DropdownMenuItem v-if="can('prestataires.update')" as-child>
                                            <Link :href="`/prestataires/${data.id}/edit`" class="flex items-center gap-2 w-full">
                                                <Pencil class="h-4 w-4" />
                                                Modifier
                                            </Link>
                                        </DropdownMenuItem>

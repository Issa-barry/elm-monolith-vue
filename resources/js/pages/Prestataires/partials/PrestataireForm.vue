...
const PAYS_OPTIONS: CountryOption[] = [
    ...
    { label: 'Guinée-Bissau', value: 'Guinée-Bissau', code: 'GW', dial: '+245', flag: '🇬🇼' },
    { label: 'Sénégal', value: 'Sénégal', code: 'SN', dial: '+221', flag: '🇸🇳' },
    { label: 'Mali', value: 'Mali', code: 'ML', dial: '+223', flag: '🇲🇱' },
    { label: "Côte d'Ivoire", value: "Côte d'Ivoire", code: 'CI', dial: '+225', flag: '🇨🇮' },
    { label: 'Liberia', value: 'Liberia', code: 'LR', dial: '+231', flag: '🇱🇷' },
    { label: 'Sierra Leone', value: 'Sierra Leone', code: 'SL', dial: '+232', flag: '🇸🇱' },
    { label: 'France', value: 'France', code: 'FR', dial: '+33', flag: '🇫🇷' },
    { label: 'Chine', value: 'Chine', code: 'CN', dial: '+86', flag: '🇨🇳' },
    { label: 'Émirats arabes unis', value: 'Émirats arabes unis', code: 'AE', dial: '+971', flag: '🇦🇪' },
        ...
        <div class="rounded-xl border bg-card p-4 sm:p-6 shadow-sm">
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div v-if="reference" class="sm:col-span-2">
                    ...
                    <div class="flex h-10 items-center rounded-md border bg-muted/40 px-3 font-mono text-sm tracking-widest text-muted-foreground select-all">
                        {{ reference }}
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    />
                    <p v-if="errors.raison_sociale" class="mt-1 text-xs text-destructive">{{ errors.raison_sociale }}</p>
                </div>
        ...
        <div class="rounded-xl border bg-card p-4 sm:p-6 shadow-sm">
            ...
            <div class="grid gap-5">
                <div class="flex items-center gap-3">
                    ...
                    />
                    <div>
                        <Label for="is_active" class="cursor-pointer font-medium">Prestataire actif</Label>

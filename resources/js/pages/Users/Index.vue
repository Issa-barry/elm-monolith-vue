...
const props = defineProps<{ users: StaffUser[]; pending_registrations: PendingUser[] }>();
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs" :hide-mobile-header="true">
        ...
        >
            <div class="border-b border-border bg-amber-50/60 px-4 py-3 dark:bg-amber-900/10">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-sm font-semibold text-amber-700 dark:text-amber-400">
                        ...
                        <span class="ml-1.5 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">
                            {{ pending_registrations.length }}
                        </span>
                    </h2>
                </div>
                <p class="mt-0.5 text-xs text-muted-foreground">
                    Ces comptes ont été créés via l'inscription et n'ont pas encore été associés à une organisation.
                </p>
            </div>
            <DataTable
                ...
                table-class="w-full"
            >
                <Column field="nom_complet" header="Utilisateur" style="min-width: 200px">
                    <template #body="{ data }">
                        <div class="flex items-center gap-3">
                            <div
                ...
                <Column field="telephone" header="Téléphone" style="width: 180px">
                    <template #body="{ data }">
                        <span class="text-sm text-muted-foreground">{{ data.telephone ?? '—' }}</span>
                    </template>
                </Column>
                <Column field="email_verified" header="Email vérifié" style="width: 140px">
                    <template #body="{ data }">
                        <span
                        ...
                        <span v-else class="text-xs text-muted-foreground">Non vérifié</span>
                    </template>
                </Column>
                <Column field="created_at" header="Inscrit le" style="width: 150px">
                    <template #body="{ data }">

...
<template>
    <div class="col-span-12 md:col-span-6 xl:col-span-3">
        <div class="card h-full">
            ...
            <div class="mt-4 flex items-start justify-between">
                <div class="w-6/12">
                    <span
                        class="text-surface-900 dark:text-surface-0 text-4xl font-bold"
                        >120</span
                    >
                    <div class="text-green-500">
                        <span class="font-medium">+12%</span>
                        <i class="pi pi-arrow-up ml-2 text-xs"></i>
                    </div>
                </div>
                <div class="w-6/12">
                    <svg
    ...
    <div class="col-span-12 md:col-span-6 xl:col-span-3">
        <div class="card h-full">
            <span class="text-lg font-semibold">Visitors</span>
            <div class="mt-4 flex items-start justify-between">
                <div class="w-6/12">
                    <span
                        class="text-surface-900 dark:text-surface-0 text-4xl font-bold"
                    ...
                    <div class="text-pink-500">
                        ...
                        <i class="pi pi-arrow-down ml-2 text-xs"></i>
                    </div>
                </div>
                <div class="w-6/12">
                    <svg

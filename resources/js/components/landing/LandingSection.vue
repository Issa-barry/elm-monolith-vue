...
<template>
    <section id="landing-section" class="bg-white p-6 lg:p-10">
        <div class="flex flex-col gap-16">
            ...
            >
                ...
                <div
                    class="h-80 w-full overflow-hidden rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-100 md:h-[34rem] md:p-8 xl:flex-1"
                >
                    <img

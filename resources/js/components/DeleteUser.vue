...
import DestroyProfileController from '@/actions/App/Http/Controllers/Settings/Profile/DestroyProfileController';
...
<template>
    <div class="space-y-6">
        <HeadingSmall
            ...
            description="Supprimez votre compte et toutes ses données associées"
        />
        <div

...
<style>
  ...
  .code { font-size: 42px; font-weight: 800; color: #1d4ed8; letter-spacing: 12px; margin: 0; font-variant-numeric: tabular-nums; }
...
<div class="wrap">
  <div class="card">
    <div class="header">
      ...
      <p class="header-title">Réinitialisation de mot de passe</p>
    </div>
    <div class="body">
      <p class="intro">

...
class PaiementPeriodeTest extends TestCase
{
    ...
    // NB : test_show_liste_les_commissions_par_vehicule(),
    // test_show_marque_le_vehicule_a_ajuster_si_ecart_non_nul() et
    // test_show_filtre_les_vehicules_par_nom_et_par_livreur() (vente Legacy)
    // supprimés — remplacés par les équivalents V2 CommissionAjustementV2Test::
    // periode_show_v2_liste_le_vehicule_avec_les_montants_attendus() /
    // periode_show_v2_marque_le_vehicule_a_ajuster_si_ecart_non_nul() /
    // periode_show_v2_filtre_les_vehicules_par_nom_et_par_livreur().

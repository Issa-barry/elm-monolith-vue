...
class PeriodePaiementServiceTest extends TestCase
{
    ...
    public function test_generate_periods_for_year_cree_96_periodes(): void
    {
        $periodes = $this->service->generatePeriodsForYear($this->org->id, 2026);

        // 4 types (livreur, propriétaire, salarié, site) × 12 mois × 2 quinzaines
        $this->assertCount(96, $periodes);
        $this->assertDatabaseCount('paiement_periodes', 96);
    }

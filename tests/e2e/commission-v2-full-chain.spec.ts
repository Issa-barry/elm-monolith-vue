 ...
 *   → reste à payer = 0
 *
 * La mise en place commune (barèmes/partage/vente/encaissement) et la
 * confirmation de dialog vivent dans commission-v2-helpers.ts (fichier non
 * ".spec" — Playwright interdit qu'un fichier de test en importe un autre),
 * réutilisée telle quelle par commission-validation-directe.spec.ts.
 */

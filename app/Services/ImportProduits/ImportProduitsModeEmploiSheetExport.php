...
class ImportProduitsModeEmploiSheetExport implements FromArray, WithEvents, WithTitle
{
    ...
    public function array(): array
    {
        return [
            ...
            [],
            ['Colonnes de tarification par nature de client — OBLIGATOIRES pour le type fabricable'],
            ['  prix_externe, prix_revendeur, prix_distributeur : remplacent prix_vente selon la nature du client qui achète (Externe/Revendeur/Distributeur).'],
            ['  Pour un produit de type fabricable, ces trois colonnes sont obligatoires (création ET mise à jour) — au même titre que prix_usine_autres_vehicules, prix_usine_tricycle et prix_vente.'],
            ['  Pour tout autre type de produit, elles restent facultatives et peuvent rester vides.'],
            ['  Ces trois tarifs sont indépendants les uns des autres et de prix_usine/prix_vente : aucune formule ne les recalcule automatiquement.'],
            [],

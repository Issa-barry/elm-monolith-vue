...
class ImportProduitsExemplesSheetExport implements FromArray, WithHeadings, WithTitle
{
    ...
    public function array(): array
    {
        ...
        // statut, code_barres, prix_achat, prix_usine_autres_vehicules,
        // prix_usine_tricycle, prix_vente, cout,
        // alerte_stock_active, seuil_alerte_stock, description] — 15 colonnes après la note,

...
/**
 * Miroir de App\Http\Controllers\Auth\RegisterLookupController (flux web) pour
 * l'app vitrine — appelée server-to-server, jamais directement par un navigateur.
 * OtpService est keyed par téléphone en cache, pas en session : aucun état à
 * partager entre la vitrine et ce serveur au-delà de cet appel.
 */

...
class CreateNewUser implements CreatesNewUsers
{
    ...
    private function linkOrCreateClient(User $user, string $telephone): void
    {
        ...
        if ($client) {
            ...
            // Client est un rôle porté par Personne (cf. docs/identite-client-personne.md) :
            // si ce client a déjà sa propre Personne (créé/backfillé côté back-office), le
            // compte doit s'y rattacher — même logique que les branches livreur/proprietaire
            // ci-dessous — plutôt que de garder la Personne "à la volée" créée en tête de
            // create(), qui deviendrait une identité fantôme dupliquée pour la même personne.
